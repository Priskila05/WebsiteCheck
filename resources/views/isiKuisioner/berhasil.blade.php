        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="bs-component">
                    ...
                    <center><h2></h2><center>
                    <img class="img-responsive" src="{{ asset('/customAuth/img/success.jpg') }}"/><br/><br/><br/>
                        <h1><font color = "black">Berhasil Terinput</font></h1>
                        <p><font color = "black">Jawaban Anda Berhasil Terinput.</font></p><br/><br/>
                        <p><a href="{{ route('home') }}" class="btn btn-info btn-lg">Kembali</a></p>
                    </div>
                </div>
            </div>
        </div>
