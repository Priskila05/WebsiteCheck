    ...
    <font color = "black">
        ...
        <form action="{{route('question.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label for="tanya" class="col-sm-2 col-form-label">Pertanyaan</label>
                <div class="col-sm-10">
                    <input type="text" name="tanya" class="form-control" id="tanya" placeholder="Pertanyaan">
                </div>
            </div>
            <div class="form-group row">
                <label for="opsi1" class="col-sm-2 col-form-label">Option A</label>
                <div class="col-sm-10">
                    <input type="text" name="opsi1" class="form-control" id="opsi1" placeholder="Option A">
                </div>
            </div>
            <div class="form-group row">
                <label for="opsi2" class="col-sm-2 col-form-label">Option B</label>
                <div class="col-sm-10">
                    <input type="text" name="opsi2" class="form-control" id="opsi2" placeholder="Option B">
                </div>
            </div>
