    ...
    <!-- Main content -->
        ...
        <font color = "black">
            <div class="row">
                ...
                <div class="col-sm-2">
                    <a class="btn btn-success" href="{{ route('question.create')}}"> Tambah Pertanyaan </a>
                </div>
            </div> 
            <br>
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th width="250x">Pertanyaan</th>
                        <th width="100px">Opsi A</th>
                        <th width="100px">Opsi B</th>
                ...
                @foreach ($questions as $question) 
                    <tr>
                        <td><b>{{++$i}}.<b></td>
                        <td>{{$question->tanya}}</td>
                        <td align-text="center">{{$question->opsi1}}</td>
                        <td align-text="center">{{$question->opsi2}}</td>
                        <td>
                            <form action="{{ route('question.destroy', $question->id) }}" method="post">
                                <a class="btn btn-sm btn-success" href="{{ route('question.show', $question->id)}}">Show</a>
