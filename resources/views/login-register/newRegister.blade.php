...
<head>
    ...
    <title>Website Check - Register</title>
...
<body background="{{ asset('/customAuth/img/background.jpg') }}">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form method="POST" class="user" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <input id="username" type="text" class="form-control form-control-user @error('username') is-invalid @enderror" name="username" value="{{ old('name') }}" required autocomplete="username" autofocus placeholder="Username">
                                    @error('username')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div div class="form-group {{ $errors->has('level') ? 'has-error' : null}}">
                                    <select class="form-select form-control-user" name="level" id="level" value="{{ old('level') }}" required autocomplete="level"> 
