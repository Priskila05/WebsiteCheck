...
<head>
    ...
    <div class="page-header">
            <center><h2></h2><center>
            <img class="img-responsive" src="{{ asset('/customAuth/img/respon.jpg') }}"/><br/><br/><br/>
            <h2 id="navbar"><font color = "black">RESPONDEN HASIL PEMANTAUAN KESEHATAN MAHASISWA</h2>
            </div><br/><br/><br/>
            <div class="jum-jumbotron">
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{ route('data.responden') }}" class="btn btn-info btn-lg">Mari Lihat Responden</a></p>
            </div>
        </div><br/><br/><br/>
            <!-- Control Sidebar -->
