...
<head>
    ...
    <div class="container">
        <div class="page-header">
            <center><h2></h2><center>
            <img class="img-responsive" src="{{ asset('/customAuth/img/Gambar2.jpg') }}"/><br/><br/><br/>
            <h2 id="navbar"><font color = "black">PEMANTAUAN KESEHATAN MAHASISWA INSTITUT TEKNOLOGI DEL</h2>
            </div><br/><br/><br/>
            <div class="jum-jumbotron">
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{ route('isiKuisioner/input') }}" class="btn btn-info btn-lg">Mulai Isi Kuisioner</a></p>
            </div>
        </div><br/><br/><br/>
            <!-- Control Sidebar -->
